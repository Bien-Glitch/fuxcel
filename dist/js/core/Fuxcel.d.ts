import { IterableElement, StringOrNull, Selector, Direction, Position, FXInterface, FXFormSubmitType, FuxcelInstance } from '../types';
...
export declare class Fuxcel extends FuxcelBase implements FuxcelInstance {
     ...
     */
    handleFormSubmit({ uri, method, data, dataType, headers, beforeSend, timeout, handleError, }?: FXFormSubmitType): Promise<{
        JSON?: any;
        text?: string;
        status: number;
